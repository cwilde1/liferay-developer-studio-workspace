...
public class CoursePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCourse.setInstructor(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingCourse.getInstructor(), newCourse.getInstructor());
	}
	...
	protected Course addCourse() throws Exception {
		...
		course.setInstructor(RandomTestUtil.randomString());
